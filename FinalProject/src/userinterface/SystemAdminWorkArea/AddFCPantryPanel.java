...
public class AddFCPantryPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(cbWH, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 50, -1, -1));
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if(!nullCheck()){
            ...
            employee.setName(txtFCPManager.getText());
            String role = "FCPManager";
            FCPantry fcp=new FCPantry();
            fcp.setFcpId("fcp"+txtFCPid.getText());
            fcp.setFcpWHname(cbWH.getSelectedItem().toString());
